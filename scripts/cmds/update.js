...
module.exports = {
	...
	langs: {
		...
		en: {
			noUpdates: "✅ | You are using the latest version of MAHABUB BOT (v%1).",
			updatePrompt: "💫 | You are using version %1. There is a new version %2. Do you want to update the chatbot to the latest version?"
				...
				+ "\n%3%4"
				+ "\n\nℹ️ | See details at https://github.com/MR-MAHABUB-004/MAHABUB-BOT-V1/commits/main"
	...
	onStart: async function ({ message, getLang, commandName, event }) {
		// Check for updates
		const { data: { version } } = await axios.get("https://raw.githubusercontent.com/MR-MAHABUB-004/MAHABUB-BOT-V1/main/package.json");
